...
ConfDir="$HOME/.config"
ThemeCtl="$ConfDir/swaybg/wall.ctl"
...
ln -fs "$getWall" "$ConfDir/swaybg/wall.set"

# Terminate existing swaybg instances to free memory
killall swaybg 2>/dev/null
# Start swaybg in background and detach
swaybg -i "$getWall" -m fill >/dev/null 2>&1 & disown
